...
function typeRequestKindToContextFlags(typeRequestKind) {
    switch (typeRequestKind) {
        ...
        case "ContextualCompletions": return 4;
    }
    ...
    return findReferenceOrConvert(node, ideObjectId => {
        ...
        if (ctx.ts.isSourceFile(node)) {
            ...
            return {
                ...
                ideObjectType: "NodeObject",
                range: {
                    start: (_c = (_b = reverseMapping === null || reverseMapping === void 0 ? void 0 : reverseMapping.sourceRange) === null || _b === void 0 ? void 0 : _b.start) !== null && _c !== void 0 ? _c : ctx.ts.getLineAndCharacterOfPosition(sourceFileParent, node.pos),
                    end: (_e = (_d = reverseMapping === null || reverseMapping === void 0 ? void 0 : reverseMapping.sourceRange) === null || _d === void 0 ? void 0 : _d.end) !== null && _e !== void 0 ? _e : ctx.ts.getLineAndCharacterOfPosition(sourceFileParent, node.end),
                },
